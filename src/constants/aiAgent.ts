...
- Tell me about yourself: Final-year BITS Pilani dual-degree student (Mechanical Engineering + Biological Sciences), career firmly in AI product strategy and operations. 3 roles — IOCL (industrial operations), Pinch (led product and operations work that reduced churn by 75% and improved finance efficiency by 300%), currently at Orange Business Services managing cloud migration projects as IT Project Manager. I build things, solve messy operational problems with clean systems, deeply excited about intersection of AI and product.
